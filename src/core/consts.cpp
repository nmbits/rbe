...
namespace rbe {
	...
	init_consts(VALUE mod)
	{
		...
		// enum orientation
		RBE_CONST_ULONG(HORIZONTAL);
		RBE_CONST_ULONG(VERTICAL);

		// enum alignment
		RBE_CONST_ULONG(ALIGN_LEFT);
		RBE_CONST_ULONG(ALIGN_RIGHT);
		RBE_CONST_ULONG(ALIGN_CENTER);
		RBE_CONST_ULONG(ALIGN_HORIZONTAL_CENTER);
		RBE_CONST_ULONG(ALIGN_HORIZONTAL_UNSET);
		RBE_CONST_ULONG(ALIGN_USE_FULL_WIDTH);

		// enum vertical_alignment
		RBE_CONST_ULONG(ALIGN_TOP);
		RBE_CONST_ULONG(ALIGN_MIDDLE);
		RBE_CONST_ULONG(ALIGN_BOTTOM);
		RBE_CONST_ULONG(ALIGN_VERTICAL_CENTER);
		RBE_CONST_ULONG(ALIGN_VERTICAL_UNSET);
		RBE_CONST_ULONG(ALIGN_NO_VERTICAL);
		RBE_CONST_ULONG(ALIGN_USE_FULL_HEIGHT);
